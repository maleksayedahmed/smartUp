...
<div class="breadcrumb-wrapper">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#"> الخدمات المدعومة </a>
        </li>
    </ol>
</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <input type="text" placeholder="الاسم" name="title" id="title"  class="form-control" />
                        ...
                        <div class="row">
                           <input type="hidden" name="id" id="id2">
                            ...
                            <div class="col-md-12">
                                <label> العنوان  </label>
                                <div class="form-group">
                                    <input type="text" placeholder="الاسم" name="title" id="title2" class="form-control" />
...
@section('js')
    ...
    <script>
     ...
     <script type="text/javascript">
        ...
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('dashboard.get_all_supports',$id) }}",
            columns: [
        ...
        $(document).on('click', '#add_user', function (e) {
            ...
            var formData = new FormData($('#add_user_form')[0]);
                $.ajax({
                    ...
                    url: "{{route('dashboard.store_supports')}}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    cache: false,
        ...
        function do_update(){
            ...
            var formData = new FormData($('#edit_user_form')[0]);
                $.ajax({
                    type: 'post',
                    enctype: 'multipart/form-data',
                    url: "{{route('dashboard.update_supports')}}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    cache: false,
   ...
   <script>
        function do_delete(){
            ...
            $.ajax({
                type: 'post',
                url: "{{route('dashboard.destroy_supports')}}",
                data: formData,
                processData: false,
                contentType: false,
                success: function (data) {
