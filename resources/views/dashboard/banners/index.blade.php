                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <textarea type="text" placeholder="الاسم" name="desc_ar" id="desc_ar"  class="form-control" rows="4"></textarea>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <textarea type="text" placeholder="الاسم" name="desc_en" id="desc_en"  class="form-control" rows="4"></textarea>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <label> الوصف بالعربي </label>
                                <div class="form-group">
                                    <textarea type="text" placeholder="الاسم" name="desc_ar" id="desc_ar2" class="form-control" rows="4"></textarea>
                            ...
                            <div class="col-md-12">
                                <label> الوصف بالانجلش </label>
                                <div class="form-group">
                                    <textarea type="text" placeholder="الاسم" name="desc_en" id="desc_en2" class="form-control" rows="4"></textarea>
...
@section('js')
        ...
        $(document).on('click', '#add_user', function (e) {
            ...
            var formData = new FormData($('#add_user_form')[0]);
                $.ajax({
                    ...
                    url: "{{route('dashboard.store_banners')}}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    cache: false,
        ...
        function do_update(){
            ...
            var formData = new FormData($('#edit_user_form')[0]);
                $.ajax({
                    type: 'post',
                    enctype: 'multipart/form-data',
                    url: "{{route('dashboard.update_banners')}}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    cache: false,
   ...
   <script>
        function do_delete(){
            ...
            $.ajax({
                type: 'post',
                url: "{{route('dashboard.destroy_banners')}}",
                data: formData,
                processData: false,
                contentType: false,
                success: function (data) {
