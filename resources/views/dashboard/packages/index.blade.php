...
@section('content')
    ...
    <button class="btn btn-outline-primary" style="display: none" onclick="msg_delete()"
        id="position-top-start_delete"></button>
    ...
    <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">الباقات </a>
            </li>
        </ol>
    </div>
    ...
    {{-- @can('اضافة طالب') --}}
    <a class="btn btn-primary" href="{{ route('dashboard.packages.create') }}" style="margin-bottom:1%">اضافة</a>
    {{-- @endcan --}}
                    ...
                    <table class="datatables-basic table table-responsive-md yajra-datatable">
                        <thead>
                            ...
                            <th>الخصائص </th> --}}
                                ...
                                <th> ملاحظة بالعربي </th>
                                <th> ملاحظة بالانجلش</th>
                                <th>العمليات</th>
                ...
                <div class="modal-content">
                    ...
                    <form id="add_user_form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span id="desc_ar_error" class="text-danger"></span>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span id="desc_en_error" class="text-danger"></span>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <label> ملاحظة بالعربي </label>
                                    <div class="form-group">
                                        <input type="text" name="note_ar" id="note_ar" class="form-control" />
                                        <span id="note_ar_error" class="text-danger"></span>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <label> ملاحظة بالانجلش </label>
                                    <div class="form-group">
                                        <input type="text" name="note_en" id="note_en" class="form-control" />
                                        <span id="note_en_error" class="text-danger"></span>
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" style="display: none" id="add_user2"
                                class="btn btn-primary btn-block">تتم الاضافة ...</button>
    ...
    <div class="form-modal-ex">
        <div class="modal fade text-left" id="edit_user" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form id="edit_user_form">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <label> الوصف بالعربي </label>
                                    <div class="form-group">
                                        <input type="text" name="desc_ar" id="desc_ar2" class="form-control" />
                                        <span id="desc_ar2_error" class="text-danger"></span>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <label> الوصف بالانجلش </label>
                                    <div class="form-group">
                                        <input type="text" name="desc_en" id="desc_en2" class="form-control" />
                                        <span id="desc_en2_error" class="text-danger"></span>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <label> ملاحظة بالعربي </label>
                                    <div class="form-group">
                                        <input type="text" name="note_ar" id="note_ar2" class="form-control" />
                                        <span id="note_ar2_error" class="text-danger"></span>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <label> ملاحظة بالانجلش </label>
                                    <div class="form-group">
                                        <input type="text" name="note_en" id="note_en2" class="form-control" />
                                        <span id="note_en2_error" class="text-danger"></span>
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" style="display: none" id="editing2"
                                class="btn btn-primary btn-block"> يتم التعديل ...</button>
                            <button type="button" id="editing" onclick="do_update()"
                                class="btn btn-primary btn-block">حفظ التعديلات</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    {{-- delete user --}}
    <div class="modal fade modal-danger text-left" id="delete_user" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" id="delete_user2" style="display: none"
                        data-dismiss="modal">...يتم الحذف</button>
                    <button type="button" class="btn btn-danger" onclick="do_delete()" id="delete_user_button"
...
@section('js')
    ...
    <script type="text/javascript">
        $(function() {
            var table = $('.yajra-datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('dashboard.get_all_packages') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
                    ...
                    // {data: 'systems'          ,name: 'systems'},
                    // {data: 'package_spec'          ,name: 'package_spec'},
                    {
                        data: 'desc_ar',
                        name: 'desc_ar',
                        searchable: false
    ...
    <script>
        $(document).on('click', '#add_user', function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('dashboard.store_packages') }}",
                data: formData,
                processData: false,
                contentType: false,
                cache: false,
    ...
    <script>
        $('#edit_user').on('show.bs.modal', function(event) {
            ...
            var note_ar = button.data('note_ar')
            var note_en = button.data('note_en')
            ...
            modal.find('.modal-body #desc_ar2').val(desc_ar);
            modal.find('.modal-body #desc_en2').val(desc_en);
            modal.find('.modal-body #note_ar2').val(note_ar);
            modal.find('.modal-body #note_en2').val(note_en);
    ...
    <script>
        function do_update() {
            ...
            $.ajax({
                type: 'post',
                enctype: 'multipart/form-data',
                url: "{{ route('dashboard.update_packages') }}",
                data: formData,
                processData: false,
                contentType: false,
                cache: false,
    ...
    <script>
        function do_delete() {
            ...
            $.ajax({
                type: 'post',
                url: "{{ route('dashboard.destroy_packages') }}",
                data: formData,
                processData: false,
                contentType: false,
                success: function(data) {
