...
<div class="breadcrumb-wrapper">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">شهادات العملاء </a>
        </li>
    </ol>
</div>
                ...
                <table class="datatables-basic table table-responsive-md yajra-datatable">
                    <thead>
                        <tr>
                            ...
                            <th>#</th>
                            <th> الاسم بالعربي</th>
                            <th> الاسم بالانجلش</th>
                            <th> المنصب الوظيفي بالعربي</th>
                            <th> المنصب الوظيفي بالانجلش</th>
                            <th>الشهادة بالعربي</th>
                            <th>الشهادة بالانجلش</th>
                            {{-- <th> الصورة</th> --}}
                            <th>العمليات</th>
                ...
                <form id="add_user_form">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <label> المنصب الوظيفي بالعربي </label>
                                <div class="form-group">
                                    <input type="text"  name="position_ar" id="position_ar"  class="form-control" />
                                    <span id="position_ar_error" class="text-danger"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <label> المنصب الوظيفي بالانجلش </label>
                                <div class="form-group">
                                    <input type="text"  name="position_en" id="position_en"  class="form-control" />
                                    <span id="position_en_error" class="text-danger"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <label> الشهادة بالعربي </label>
                                <div class="form-group">
                                    <textarea type="text"  name="content_ar" id="content_ar"  class="form-control" rows="3"></textarea>
                                    <span id="content_ar_error" class="text-danger"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <label> الشهادة بالانجلش</label>
                                <div class="form-group">
                                    <textarea type="text"  name="content_en" id="content_en"  class="form-control" rows="3"></textarea>
                                    <span id="content_en_error" class="text-danger"></span>
                                </div>
                            </div>
                        ...
                        <div class="row">
                           <input type="hidden" name="id" id="id2">
                            <div class="col-md-12">
                                <label> الاسم بالعربي </label>
                                <div class="form-group">
                                    <input type="text"  name="name_ar" id="name_ar2" class="form-control" />
                                    <span id="name_ar2_error" class="text-danger"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <label> الاسم بالانجلش </label>
                                <div class="form-group">
                                    <input type="text"  name="name_en" id="name_en2" class="form-control" />
                                    <span id="name_en2_error" class="text-danger"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <label> المنصب الوظيفي بالعربي </label>
                                <div class="form-group">
                                    <input type="text"  name="position_ar" id="position_ar2" class="form-control" />
                                    <span id="position_ar2_error" class="text-danger"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <label> المنصب الوظيفي بالانجلش </label>
                                <div class="form-group">
                                    <input type="text"  name="position_en" id="position_en2" class="form-control" />
                                    <span id="position_en2_error" class="text-danger"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <label> الشهادة بالعربي </label>
                                <div class="form-group">
                                    <textarea type="text"  name="content_ar" id="content_ar2"  class="form-control" rows="3"></textarea>
                                    <span id="content_ar2_error" class="text-danger"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <label> الشهادة بالانجلش</label>
                                <div class="form-group">
                                    <textarea type="text"  name="content_en" id="content_en2"  class="form-control" rows="3"></textarea>
                                    <span id="content_en2_error" class="text-danger"></span>
                                </div>
                            </div>
...
@section('js')
    ...
    <script>
     ...
     <script type="text/javascript">
        ...
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('dashboard.get_all_testimonials') }}",
            columns: [
                {data: 'DT_RowIndex'     ,name: 'DT_RowIndex', orderable: false, searchable: false},
                {data: 'name_ar'         ,name: 'name_ar'},
                {data: 'name_en'         ,name: 'name_en'},
                {data: 'position_ar'     ,name: 'position_ar', searchable: false},
                {data: 'position_en'     ,name: 'position_en', searchable: false},
                {data: 'content_ar'     ,name: 'content_ar', searchable: false},
        ...
        $(document).on('click', '#add_user', function (e) {
            ...
            var formData = new FormData($('#add_user_form')[0]);
                $.ajax({
                    ...
                    url: "{{route('dashboard.store_testimonials')}}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    cache: false,
    ...
    <script>
        $('#edit_user').on('show.bs.modal', function(event) {
            ...
            var position_ar =                button.data('position_ar')
            var position_en =                button.data('position_en')
            ...
            modal.find('.modal-body #name_ar2').val(name_ar);
            modal.find('.modal-body #name_en2').val(name_en);
            modal.find('.modal-body #position_ar2').val(position_ar);
            modal.find('.modal-body #position_en2').val(position_en);
            modal.find('.modal-body #content_ar2').val(content_ar);
            modal.find('.modal-body #content_en2').val(content_en);
        ...
        function do_update(){
            ...
            var formData = new FormData($('#edit_user_form')[0]);
                $.ajax({
                    type: 'post',
                    enctype: 'multipart/form-data',
                    url: "{{route('dashboard.update_testimonials')}}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    cache: false,
   ...
   <script>
        function do_delete(){
            ...
            $.ajax({
                type: 'post',
                url: "{{route('dashboard.destroy_testimonials')}}",
                data: formData,
                processData: false,
                contentType: false,
                success: function (data) {
