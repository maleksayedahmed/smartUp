...
<div class="breadcrumb-wrapper">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">الصور الفرعية </a>
        </li>
    </ol>
</div>
                ...
                <form id="add_user_form">
                    ...
                    <div class="modal-body">
                        <div class="row">
                             ...
                             <input type="hidden" name="primary_image_id" value="{{ $id }}">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <input type="hidden" name="id" id="id2">
                             <input type="hidden" name="primary_image_id" id='primary_image_id_edit'>
...
@section('js')
    ...
    <script>
     ...
     <script type="text/javascript">
        ...
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('dashboard.get_all_galleryImages',$id) }}",
            columns: [
        ...
        $(document).on('click', '#add_user', function (e) {
            ...
            var formData = new FormData($('#add_user_form')[0]);
                $.ajax({
                    ...
                    url: "{{route('dashboard.store_galleryImages')}}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    cache: false,
    ...
    <script>
        $('#edit_user').on('show.bs.modal', function(event) {
            ...
            var primary_image_id =               button.data('primary_image_id')



            var modal = $(this)
            modal.find('.modal-body #id2').val(id);
            modal.find('.modal-body #primary_image_id_edit').val(primary_image_id);
        ...
        function do_update(){
            ...
            var formData = new FormData($('#edit_user_form')[0]);
                $.ajax({
                    type: 'post',
                    enctype: 'multipart/form-data',
                    url: "{{route('dashboard.update_galleryImages')}}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    cache: false,
   ...
   <script>
        function do_delete(){
            ...
            $.ajax({
                type: 'post',
                url: "{{route('dashboard.destroy_galleryImages')}}",
                data: formData,
                processData: false,
                contentType: false,
                success: function (data) {
