...
<div class="breadcrumb-wrapper">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">أنظمة الباقات  </a>
        </li>
    </ol>
</div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel33">اضافة نظام</h4>
                    ...
                    <div class="modal-body">
                            ...
                            <div class="row">
                                    <div class="col-md-12">
                                         <div class="form-group">
                                            ...
                                            <select class="form-control" name="system_id" id="system_id" id="exampleFormControlSelect1">
                                                @foreach($systems as $system)
                                                            <option value="{{ $system->id }}">{{ $system->title_ar }}</option>
                                                    @endforeach
                                            </select>
                                            <span id="system_id_error" class="text-danger"></span>
                                        </div>
                                    </div>
                            </div>
                            @else
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <input type="text" placeholder="الاسم" name="title_ar" id="title_ar"  class="form-control" />
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <input type="text" placeholder="الاسم" name="title_en" id="title_en"  class="form-control" />
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <input type="text" placeholder="الاسم" name="desc_ar" id="desc_ar"  class="form-control" />
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <input type="text" placeholder="الاسم" name="desc_en" id="desc_en"  class="form-control" />
                        ...
                        <div class="row">
                           ...
                           <input type="hidden" name="package_id" id="package_id_edit">
                            ...
                            <div class="col-md-12">
                                <label> العنوان بالعربي </label>
                                <div class="form-group">
                                    <input type="text" placeholder="الاسم" name="title_ar" id="title_ar2" class="form-control" />
                            ...
                            <div class="col-md-12">
                                <label> العنوان بالانجلش </label>
                                <div class="form-group">
                                    <input type="text" placeholder="الاسم" name="title_en" id="title_en2" class="form-control" />
                            ...
                            <div class="col-md-12">
                                <label> الوصف بالعربي </label>
                                <div class="form-group">
                                    <input type="text" placeholder="الاسم" name="desc_ar" id="desc_ar2" class="form-control" />
                            ...
                            <div class="col-md-12">
                                <label> الوصف بالانجلش </label>
                                <div class="form-group">
                                    <input type="text" placeholder="الاسم" name="desc_en" id="desc_en2" class="form-control" />
...
@section('js')
    ...
    <script>
     ...
     <script type="text/javascript">
        ...
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('dashboard.get_all_systems',$id) }}",
            columns: [
   ...
   <script>
        function do_delete(){
            ...
            $.ajax({
                type: 'post',
                url: "{{route('dashboard.destroy_systems')}}",
                data: formData,
                processData: false,
                contentType: false,
                success: function (data) {
