            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <i class="fab fa-snapchat text-warning mr-1"></i>
                ...
                <div class="modal-content">
                    ...
                    <form id="edit_user_form" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="mobile" value="{{ $contact_infos->mobile }}"
                                            class="form-control" />
                                ...
                                <div class="col-md-6">
                                    <label>ايميل</label>
                                    <div class="form-group">
                                        <input type="text" name="email" value="{{ $contact_infos->email }}"
                                            class="form-control" />
                                ...
                                <div class="col-md-6">
                                    <label>فيس بوك</label>
                                    <div class="form-group">
                                        <input type="text" name="facebook" value="{{ $contact_infos->facebook }}"
                                            class="form-control" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="instagram" value="{{ $contact_infos->instagram }}"
                                            class="form-control" />
                                ...
                                <div class="col-md-6">
                                    <label>تيك توك</label>
                                    <div class="form-group">
                                        <input type="text" name="tiktok" value="{{ $contact_infos->tiktok }}"
                                            class="form-control" />
                                ...
                                <div class="col-md-6">
                                    <label>يوتيوب</label>
                                    <div class="form-group">
                                        <input type="text" name="youtube" value="{{ $contact_infos->youtube }}"
                                            class="form-control" />
                                ...
                                <div class="col-md-6">
                                    <label>واتساب</label>
                                    <div class="form-group">
                                        <input type="text" name="whatsapp" value="{{ $contact_infos->whatsapp }}"
                                            class="form-control" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="snapchat" value="{{ $contact_infos->snapchat }}"
                                            class="form-control" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="linkedin" value="{{ $contact_infos->linkedin }}"
                                            class="form-control" />
                                ...
                                <div class="col-md-6">
                                    <label>X</label>
                                    <div class="form-group">
                                        <input type="text" name="X" value="{{ $contact_infos->X }}"
                                            class="form-control" />
                                ...
                                <div class="col-md-6">
                                    <label>العنوان</label>
                                    <div class="form-group">
                                        <input type="text" name="address" value="{{ $contact_infos->address }}"
                                            class="form-control" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="{{ asset($contact_infos->logo) }}" id="image"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="site_name" value="{{ $contact_infos->site_name }}"
                                            class="form-control" />
                        ...
                        <div class="modal-footer">
                            <button type="button" style="display: none" id="editing_loader"
                                class="btn btn-primary btn-block"> يتم التعديل ...</button>
                            <button type="button" id="editing_btn" onclick="do_update()"
