...
<div class="breadcrumb-wrapper">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">أنظمة الواجهة الرئيسية  </a>
        </li>
    </ol>
</div>
                        ...
                        <div class="row">
                           <input type="hidden" name="id" id="id2">
                            ...
                            <div class="col-md-12">
                                <label> الوصف بالعربي </label>
                                <div class="form-group">
                                    <input type="text"  name="description_ar" id="description_ar2" class="form-control" />
                            ...
                            <div class="col-md-12">
                                <label> الوصف بالانجلش </label>
                                <div class="form-group">
                                    <input type="text"  name="description_en" id="description_en2" class="form-control" />
...
@section('js')
    ...
    <script>
     ...
     <script type="text/javascript">
        ...
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('dashboard.get_all_main_systems') }}",
            columns: [
                {data: 'DT_RowIndex'     ,name: 'DT_RowIndex', orderable: false, searchable: false},
                {data: 'name_ar'        ,name: 'name_ar'},
                {data: 'name_en'        ,name: 'name_en'},
                {data: 'description_ar'  ,name: 'description_ar', searchable: false},
        ...
        $(document).on('click', '#add_user', function (e) {
            ...
            var formData = new FormData($('#add_user_form')[0]);
                $.ajax({
                    ...
                    url: "{{route('dashboard.store_main_systems')}}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    cache: false,
        ...
        function do_update(){
            ...
            var formData = new FormData($('#edit_user_form')[0]);
                $.ajax({
                    type: 'post',
                    enctype: 'multipart/form-data',
                    url: "{{route('dashboard.update_main_systems')}}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    cache: false,
   ...
   <script>
        function do_delete(){
            ...
            $.ajax({
                type: 'post',
                url: "{{route('dashboard.destroy_main_systems')}}",
                data: formData,
                processData: false,
                contentType: false,
                success: function (data) {
