...
<div class="breadcrumb-wrapper">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">مرفقات النظام  </a>
        </li>
    </ol>
</div>
                    ...
                    <div class="modal-body">
                       ...
                       <!-- النوع -->
                            ...
                            <div class="form-group">
                                <label for="system_type">النوع </label>
                            ...
                            <!-- رابط الفيديو -->
                            <div class="col-md-12" id="video_input_wrapper" style="display: none;">
                            <label>الرابط</label>
                            <div class="form-group">
                                <input type="text" name="link_video" id="link_video" class="form-control" />
                                <span id="link_video_error" class="text-danger"></span>
                            </div>
                            </div>

                            <!-- اختيار الصورة -->
                            <div class="col-md-12" id="image_input_wrapper" style="display: none;">
                            <div class="media mb-2">
                                ...
                                <div class="col-12 d-flex mt-1 px-0">
                                    ...
                                    <input class="form-control" type="file" id="change-picture" name="image" hidden required accept="image/png, image/jpeg, image/jpg" />
                ...
                <form id="edit_user_form">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <input type="hidden" name="system_id" id='system_id_edit'>
...
@section('js')
    ...
    <script>
     ...
     <script type="text/javascript">
        ...
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('dashboard.get_all_systems_attachments',$id) }}",
            columns: [
        ...
        $(document).on('click', '#add_user', function (e) {
            ...
            var formData = new FormData($('#add_user_form')[0]);
                $.ajax({
                    ...
                    url: "{{route('dashboard.store_systems_attachments')}}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    cache: false,
    ...
    <script>
        $('#edit_user').on('show.bs.modal', function(event) {
            ...
            modal.find('.modal-body #system_id_edit').val(system_id);
        ...
        function do_update(){
            ...
            var formData = new FormData($('#edit_user_form')[0]);
                $.ajax({
                    type: 'post',
                    enctype: 'multipart/form-data',
                    url: "{{route('dashboard.update_systems_attachments')}}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    cache: false,
   ...
   <script>
        function do_delete(){
            ...
            $.ajax({
                type: 'post',
                url: "{{route('dashboard.destroy_systems_attachments')}}",
                data: formData,
                processData: false,
                contentType: false,
                success: function (data) {
  ...
  // في البداية نحدد الحالة حسب الافتراضي
  function toggleFields() {
    const type = $('#system_type').val();
    if (type === 'image') {
      $('#image_input_wrapper').show();
      $('#video_input_wrapper').hide();
    } else if (type === 'video') {
      $('#video_input_wrapper').show();
      $('#image_input_wrapper').hide();
    } else {
      $('#image_input_wrapper, #video_input_wrapper').hide();
    }
  }
    ...
    // لو عايز لما يضغط على الصورة يفتحها كبير
    $('#image').on('click', function () {
        ...
        <html>
            ...
            <style>body{margin:0;display:flex;justify-content:center;align-items:center;background:#111;}img{max-width:100%;max-height:100%;}</style>
            </head>
            <body>
